    ...
    sections: [
      {
        ...
        intro: 'The standard Group Critical Illness policy provides financial support to employees diagnosed with serious illness. The international version extends this coverage worldwide, simplifying administration compared to purchasing separate country-specific plans.',
        items: [
      ...
      },
      {
        type: 'intro',
        label: 'The basics',
        title: 'What is International Group Critical Illness Insurance?',
        paragraphs: [
          'The standard Group Critical Illness policy provides financial support to employees diagnosed with serious illness. The international version extends this coverage worldwide, simplifying administration compared to purchasing separate country-specific plans.',
          'Employers pay premiums; employees receive tax-free lump sum payments upon diagnosis of covered illnesses. Coverage amounts typically range from 1x to 5x salary, or predetermined flat amounts (USD/GBP/EUR 100,000). Two plan levels are available: "Core" covering 7 conditions and "Extended" covering up to 22 conditions.',
        ],
      },
      {
        type: 'coverage',
        label: 'Covered conditions',
        title: 'What conditions are covered?',
        intro: 'International Group Critical Illness policies typically cover a range of serious conditions, including:',
        items: [
          'Cancer',
          'Heart attack',
          'Kidney failure',
      ...
      },
      {
        type: 'text-block',
        label: 'Why offer it',
        title: 'Why offer International Group Critical Illness cover?',
        paragraphs: [
          'Covers up to 41 different conditions, providing a tax-free lump sum that employees can use for childcare, medical expenses, rent or mortgage payments, and tax bills.',
          'Research shows employees are unable to pay their bills beyond 3 months without income — making critical illness cover particularly valuable for expatriate staff in high cost-of-living regions.',
          'According to the Association of British Insurers (ABI), the average critical illness claim value was £67,000 in 2020.',
          'The policy also aids in the recruitment and retention of quality staff, demonstrating a meaningful commitment to employee wellbeing regardless of where they are based.',
        ],
      },
      {
        type: 'faqs',
        items: [
          {
            q: 'What are the top claimed conditions?',
            a: 'The top three are cancer, heart conditions and stroke.',
          },
          {
            q: 'How quickly is a payout made?',
          ...
          {
            q: 'What is the maximum age for coverage?',
            a: 'Typically, the maximum age of cover is 65.',
          },
          {
            q: 'Can children and partners be included?',
          ...
          {
            q: 'What currency options are available?',
          ...
          {
            q: 'How are multi-currency salaries handled?',
