...
export const employeeBenefitsServices: ServiceEntry[] = [
  ...
  // ── Group Life Insurance ───────────────────────────────────────────────
  {
    ...
    sections: [
      ...
      },
      {
        ...
        rows: [
          { staffCount: '5', details: ['2x salary benefit', 'Average age – 42', 'Salary roll – £150,000', 'Home Counties location', 'New to market with no long-term absentees', '£500 total premium per annum'] },
          { staffCount: '10', details: ['2x salary benefit', 'Average age – 42', 'Salary roll – £300,000', 'Home Counties location', 'New to market with no long-term absentees', '£600 total premium per annum'] },
          { staffCount: '20', details: ['2x salary benefit', 'Average age – 42', 'Salary roll – £1,200,000', 'Home Counties location', 'New to market with no long-term absentees', '£840 total premium per annum'] },
          { staffCount: '50', details: ['2x salary benefit', 'Average age – 42', 'Salary roll – £3,000,000', 'Home Counties location', 'New to market with no long-term absentees', '£2,064 total premium per annum'] },
        ],
      },
      {
        type: 'faqs',
  ...
  // ── Group Income Protection ────────────────────────────────────────────
  {
    ...
    tagline: 'Engage Group Income Protection',
    subtitle: 'Financial & practical support when ill-health strikes.',
    icon: Activity,
    colorScheme: 'purple',
    stats: [
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          'Group Income Protection provides financial support should an employee be unable to work due to significant illness or injury. But it\'s not just about finances – An Income Protection scheme will often include practical support to help employees return to good health and get back to work. You might also hear the policy referred to as business income protection, disability protection or employee sick pay.',
        ],
      },
      {
        type: 'intro',
        ...
        paragraphs: [
          'With these plans, the employer is actually the beneficiary, not the employee, even though it\'s the employee that\'s insured. The employer typically selects a defined percentage of their employees\' salaries to insure if they become long-term absent due to illness or injury. For example, you may choose to insure your employees for 75% of their salary.',
          'In this instance, if an employee becomes unable to work, the employer receives the 75% of salary from the insurer and is able to comfortably continue paying their staff member whilst they are unwell. This means that the employer can afford a temporary replacement for their absent team member and commit to their recovery and eventual return to work.',
        ],
      },
      {
        type: 'text-block',
        label: 'Group Income Protection',
        title: 'What are the benefits of Income Protection Insurance?',
        paragraphs: [
          'These are some of the reasons that businesses are selecting Group Income Protection:',
        ],
        items: [
          'Provides a monthly income for staff if they can\'t work due to illness/injury',
          'Reduces the strain on the employer to keep paying an unwell employee',
          'Assists with moral and financial obligation employer feels for staff',
          'Insurer helps facilitate a quick return to work for the employee',
          'Makes available a broad range of rehabilitation tools and services',
        ],
        footerParagraphs: [
          'There are a range of support services which Group Income Protection providers offer to assist employees whilst absent. These can include: Virtual GP\'s, Mental health support, Physiotherapy, Second opinion service, Employee Assistance Programme (EAP), Rehabilitation.',
          'For example, Canada Life offers an extensive range of virtual services which includes 24/7 access to GP consultation, an early intervention service which starts on day one of an absence, access to second medical opinions from expert consultants, and offers a range of additional perks such as cinema tickets. However, every insurer offers some level of support service. The idea behind the support is simple: it is designed to help your employees make a speedy recovery from whatever injury or illness they are suffering from. Vitality paid out 96.8% of Income Protection claims in 2020.',
        ],
      },
      {
        type: 'text-block',
        ...
        items: [
          'Coverage period: A temporary (or short-term) plan is a policy which typically provides coverage for a 1, 2 or 5 year period (plans can start from as little as 0.25% of gross payroll). A long term plan will cover employees up to retirement should they not be able to work. Unsurprisingly, a long-term plan will attract a higher premium (usually around 1% and 2% of gross payroll).',
          'Medical history: The previous medical history of your team will also influence the premium. This tells insurers how likely it is that a claim will be made. The higher the likelihood, the higher the premium.',
          'Age & occupation: The age of the workforce and the type of work performed can both be factors which influence the cost.',
          'Percentage of income covered: Many businesses opt for a minimum of 50%, but most select between 60-75%. The higher the percentage, the higher the premium will be.',
          'The range of injuries and illnesses covered: The lower the range of ailments provided for, the lower the cost and vice versa.',
          'Deferral period: Every plan has a "deferred period". This is the period of time which an employee must be absent from work before a claim can begin. Most businesses opt for 13 or 26 weeks to align with their internal sickness absence policies, but it\'s possible to have up to 1 year. The shorter the deferral period, the higher the premium is likely to be.',
          'Standard or guaranteed premium: A standard premium can be increased by the insurer over time, while a guaranteed premium freezes the premium (meaning it won\'t go up).',
          'Monthly or annual pay: Some insurers will provide a financial incentive to pay annually as opposed to monthly.',
        ],
        footerParagraphs: [
      ...
      },
      {
        ...
        paragraphs: [
          'There are two main options for finding the best deal on Business Protection Insurance: Research the market and negotiate directly with insurance companies yourself, or employ an expert business health insurance broker to do the work for you.',
          'In the first case, a business owner or HR manager must independently research all the different Income Protection policies on the market. While this, in theory, reduces costs associated with employing a broker, it requires a major investment in time. One of the key problems is that you will be negotiating directly with sales advisors. While they will have some knowledge of the industry, their main area of expertise is in persuading you about the benefits of the product they are offering. The sales spiel can be very persuasive, yet the end result not necessarily what you needed.',
