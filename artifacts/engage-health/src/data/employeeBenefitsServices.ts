    ...
    sections: [
      {
        ...
        paragraphs: [
          'Group Income Protection provides financial support should an employee be unable to work due to significant illness or injury. But it\'s not just about finances…',
          'An Income Protection scheme will often include practical support to help employees return to good health and get back to work.',
          'You might also hear the policy referred to as "business income protection", "disability protection" or "employee sick pay".',
        ],
      },
      {
        type: 'intro',
      ...
      },
      {
        ...
        items: [
          ...
          'Deferral period: Every plan has a "deferred period". This is the period of time which an employee must be absent from work before a claim can begin. Most businesses opt for 13 or 26 weeks to align with their internal sickness absence policies, but it\'s possible to have up to 1 year. The shorter the deferral period, the higher the premium is likely to be. Important! Employers shouldn\'t wait until the deferred period has expired before reaching out to their insurer or employee benefit consultancy. The earlier you can register an absent member of staff, the more chance there is of providing support services and returning them to work.',
      ...
      },
      {
        ...
        paragraphs: [
          ...
          '1. Research the market and negotiate directly with insurance companies yourself',
          '2. Employ an expert business health insurance broker to do the work for you',
      ...
      },
      {
        ...
        items: [
          ...
          { name: 'Zurich', logo: zurichLogo, quote: 'Our in-house team of rehabilitation specialists are on hand to offer practical support and expertise from the employee\'s initial absence through to recovery.' },
